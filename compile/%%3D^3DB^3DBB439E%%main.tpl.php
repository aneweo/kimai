...
?>
<?php if ($this->_tpl_vars['object']['EXTENSION_NAME'] && $this->_tpl_vars['object']['EXTENSION_KEY'] != 'ki_timesheet'): ?>
...
, '<?php echo $this->_tpl_vars['object']['EXTENSION_INIT_FILE']; ?>
'); <?php echo $this->_tpl_vars['object']['TAB_CHANGE_TRIGGER']; ?>
;">
                    <span class="aa">&nbsp;</span>
                    <span class="bb">
                    <?php if (isset ( $this->_tpl_vars['kga']['lang']['extensions'][$this->_tpl_vars['object']['EXTENSION_KEY']] )): ?>
                    <?php echo $this->_tpl_vars['kga']['lang']['extensions'][$this->_tpl_vars['object']['EXTENSION_KEY']]; ?>

                    <?php else: ?>
                    <?php echo ((is_array($_tmp=$this->_tpl_vars['object']['EXTENSION_NAME'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
...
?>
<?php if ($this->_tpl_vars['object']['EXTENSION_KEY'] != 'ki_timesheet'): ?>
		<div id="extdiv_<?php echo $this->_foreach['extensionloop']['iteration']; ?>
" class="ext <?php echo $this->_tpl_vars['object']['EXTENSION_KEY']; ?>
