...
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'zef.tpl', 1, false),array('modifier', 'date_format', 'zef.tpl', 34, false),array('modifier', 'escape', 'zef.tpl', 54, false),array('modifier', 'replace', 'zef.tpl', 185, false),array('modifier', 'nl2br', 'zef.tpl', 277, false),)), $this); ?>
...
<?php endif; ?>
                    ...
                    <td nowrap class="option 
                                            <?php if (((is_array($_tmp=$this->_tpl_vars['arr_zef'][$this->_sections['row']['index']]['zef_in'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d") : smarty_modifier_date_format($_tmp, "%d")) != $this->_tpl_vars['day_buffer']): ?>
                                                <?php if ($this->_tpl_vars['kga']['show_daySeperatorLines']): ?>break_day<?php endif; ?>
                                            <?php else: ?>
                                                <?php if ($this->_tpl_vars['arr_zef'][$this->_sections['row']['index']]['zef_out'] != $this->_tpl_vars['zef_in_buffer']): ?>
...
" style="display:none;">
                    <td colspan="10"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arr_zef'][$this->_sections['row']['index']]['zef_comment'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</td>
                </tr>
